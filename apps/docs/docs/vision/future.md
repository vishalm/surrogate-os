...
### The Surrogate Marketplace Emerges
...
### Federated Learning Creates the Moat
...
### Surrogate Identity Becomes Legally Recognized

The liability framework will mirror medical device liability:
- **Platform** → liable for the SOP being accurate and the system behaving accordingly
- **Organization** → liable for using the surrogate correctly within certified scope
- **Human supervisor** → liable for decisions they explicitly approved
...
:::warning The risk we take seriously
...
### Letter to the Founders of 2045
...
*Back to: [The Central Thesis](/docs/vision/thesis) · [Strategy & Market](/docs/strategy/market)*
