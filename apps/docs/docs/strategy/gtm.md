...
description: "Beachhead strategy, pilot design, expansion playbook, messaging architecture, and sales motion for the first $10M ARR."
---
...
```mermaid
graph LR
    L["<b>Land</b><br/>3 surrogates<br/>2 wards, 1 role<br/><i>$48K ARR</i>"] --> E1["<b>Expand 1</b><br/>+ Second role<br/><i>$72K ARR</i>"]
    E1 --> E2["<b>Expand 2</b><br/>+ More depts<br/><i>$144K ARR</i>"]
    E2 --> E3["<b>Expand 3</b><br/>Org-wide rollout<br/><i>$480K ARR</i>"]
    E3 --> E4["<b>Expand 4</b><br/>Network-level<br/><i>$2.4M ARR</i>"]

    style L fill:#4f46e5,color:#fff,stroke:none
    style E4 fill:#059669,color:#fff,stroke:none
```
