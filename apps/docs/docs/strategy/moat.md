...
```mermaid
graph TD
    SC["<b>SOP Corpus</b><br/>Data moat"] -->|reinforces| TI["<b>Trust Infrastructure</b><br/>Accountability moat"]
    SC -->|enables| PL["<b>Persona Library</b><br/>Content moat"]
    TI -->|accelerates| RC["<b>Regulatory Certification</b><br/>Permission moat"]
    RC -->|enables| PL
    PL -->|deepens| IM["<b>Institutional Memory</b><br/>Switching cost moat"]
    RC -->|strengthens| HB["<b>Humanoid Bridge</b><br/>Category moat"]
    IM -->|feeds| SC
    HB -->|enriches| SC

    style SC fill:#4f46e5,color:#fff,stroke:none
    style TI fill:#7c3aed,color:#fff,stroke:none
    style PL fill:#2563eb,color:#fff,stroke:none
    style RC fill:#059669,color:#fff,stroke:none
    style IM fill:#d97706,color:#fff,stroke:none
    style HB fill:#dc2626,color:#fff,stroke:none
```
